# Hermes Agent Project News — 2026-08-18

> Public GitHub release and roadmap evidence. Upcoming items are indications, not commitments.

Repository: [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)

## Latest stable: [Hermes Agent v0.20.3 (2026.8.16.2)](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.8.16.2)
