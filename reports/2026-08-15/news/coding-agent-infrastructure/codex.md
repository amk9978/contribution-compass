# Codex Project News — 2026-08-15

> Public GitHub release and roadmap evidence. Upcoming items are indications, not commitments.

Repository: [openai/codex](https://github.com/openai/codex)

## Latest stable: [0.147.0](https://github.com/openai/codex/releases/tag/rust-v0.147.0)

- Tag: `rust-v0.147.0`
- Published: 2026-08-07T01:41:49Z
- New Features
...
- **Prerelease** [0.148.0-alpha.19](https://github.com/openai/codex/releases/tag/rust-v0.148.0-alpha.19)
- **Prerelease** [0.148.0-alpha.18](https://github.com/openai/codex/releases/tag/rust-v0.148.0-alpha.18)
- **Prerelease** [0.148.0-alpha.17](https://github.com/openai/codex/releases/tag/rust-v0.148.0-alpha.17)
