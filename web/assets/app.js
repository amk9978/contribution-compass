/* Progressive client-side filtering only; all data and HTML are generated by Python. */

const root = document.documentElement;
const themeToggle = document.querySelector(".theme-toggle");
const storedTheme = localStorage.getItem("contribution-compass-theme");
...
themeToggle?.addEventListener("click", () => {
  ...
  localStorage.setItem("contribution-compass-theme", theme);
});
